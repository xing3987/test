...
/*
相交链表
思路：递归校验1个ListNode当前节点是否和另一个中的某个节点相同，如果不相同校验下一个节点
*/
    ...
    public class Solution {
        ...
        public ListNode getIntersectionNode(ListNode headA, ListNode headB) {
            if (null != headA && null != headB) {
                if (null != valideNode(headA, headB)) {
                    return valideNode(headA, headB);
                }
        ...
        //校验当前节点是否是重复节点
        private ListNode valideNode(ListNode nodeA, ListNode nodeB) {
            if (null != nodeA && null != nodeB) {
                if (nodeA == nodeB) {
                    return nodeA;
                }
                return valideNode(nodeA, nodeB.next);
            }
            return null;
        }
    }
